...
My name is Geoff Pado. I'm a software developer based out of ~~Columbia, MO~~. (**Update:** Seattle, WA) ~~I build mobile apps for all the major platforms, desktop apps for OS X and Windows, and server-side backends for&hellip; whatever you can get to run Ruby, I guess.~~ (**Update:** I'm now basically all-in on iOS for mobile, and my server-side love is more in Clojure these days than Ruby.)
