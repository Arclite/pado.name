...
- [Fix sorting of images](https://git.pado.name/highlighter/app/issues/43)
- [Fix color of photo cell while loading image](https://git.pado.name/highlighter/app/issues/44)
